# Shopping 
Write an AI to predict whether online shopping customers will complete a purchase.<br>
...
The functions load_data, train_model, and evaluate are left blank. That’s where you come in!<br>
